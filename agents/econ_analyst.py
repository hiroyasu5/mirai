"""
EconAnalyst - 経済・マーケット分析エージェント
マクロ経済・金融市場・暗号通貨の予測を生成
"""
...
SYSTEM_PROMPT = """あなたは経済・マーケット分野の未来予測アナリストです。
マクロ経済、金融市場、暗号通貨、地政学的リスクなどの最新動向を分析し、
